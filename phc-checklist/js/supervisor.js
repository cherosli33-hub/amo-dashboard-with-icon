...
function renderLogin(message=""){
  root.innerHTML=`<section class="card supervisor-login"><span class="supervisor-shield">♜</span><h1>Akses Penyelia</h1><p>Log masuk menggunakan akaun Google penyelia yang telah didaftarkan.</p>${message?`<div class="connection-banner pending"><strong>Log masuk gagal</strong><span>${esc(message)}</span></div>`:""}<div id="googleButton"></div><small>Kata laluan Google tidak dihantar atau disimpan oleh PHC Checklist.</small></section>`;
